...
def cargar_datos():
    ...
    if opcion == "Subir archivo CSV":
        ...
        if archivo:
            ...
            # Interpolación para rellenar valores faltantes solo en columnas numéricas
            gdf = gdf.apply(lambda col: col.interpolate(method='linear', axis=0, limit_direction='both') 
